...
connection = pymysql.connect(host="localhost", user="root", password="Rodsader1*", db="pdf")
...
insert_data = ('4', 'A', '440', 'N', 'N', 'BR DOOR NEEDS PAINT', 'Not')
insert_data1 = ('4', 'A', '440', 'N', 'N', 'PEEPHOLE NEEDED', 'Not')
